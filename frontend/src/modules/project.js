...
const CHANGE_FIELD = "project/CHANGE_FIELD";
const CHANGE_FIELD_WO_FORM = "project/CHANGE_FIELD_WO_FORM";
const INITIALIZE_FORM = 'project/INITIALIZE_FORM';
const INITIALIZE_STATE = 'project/INITIALIZE_STATE';
